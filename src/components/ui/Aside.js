            ...
            <aside>
                ...
                <div className="bottom sticky">
                    ...
                    <div className="buttons">
                        <a href="javascript:void(0);" className="button grey open-add-client-dialog">Add New Client</a>
                        <a href="javascript:void(0);" className="button grey open-add-client-dialog">Open a Ticket</a>
                    </div>
                </div>
            </aside>
