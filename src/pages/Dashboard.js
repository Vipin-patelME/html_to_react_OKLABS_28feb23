            ...
            <section id="content" className="container_12 clearfix" data-sort="true">
                ...
                <div className="grid_12">
                    ...
                    <div className="header">
                        ...
                        <a href="javascript:void(0);" className="menu icon-cog" />
                        <menu>
                        <a href="javascript:void(0);" className="open-add-client-dialog"><span className="icon icon-plus" />Add Client</a>
                        <a href="javascript:void(0);"><div className="icon icon-pencil" />Edit</a>
                        <a href="javascript:void(0);"><div className="icon icon-remove" />Remove</a>
                        </menu>
                    </div>
